using ExpenseClaims.Api.Services;
using ExpenseClaims.Application.DTOs.Settings;
...
using ExpenseClaims.Infrastructure.Identity.Services;
using ExpenseClaims.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\ExpenseClaims.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
