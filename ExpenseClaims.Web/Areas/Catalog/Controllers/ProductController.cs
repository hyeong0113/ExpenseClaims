using ExpenseClaims.Application.Constants;
...
using ExpenseClaims.Application.Features.Products.Commands.Delete;
...
using ExpenseClaims.Web.Abstractions;
using ExpenseClaims.Web.Areas.Catalog.Models;
using ExpenseClaims.Web.Extensions;
...
namespace ExpenseClaims.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
